/*
Tutoriales SQL SERVER |  #60 Procedimientos Almacenados [Info]
sp_help --> Muestra objetos de la base de datos sirve para todos losobjetos, pero vamos a usarlo con procedimientos

*/

sp_help --> Muestra objetos de la base de datos

sp_helptext seleccion --Texto que define el objeto, muestra todo el contenido del stored
